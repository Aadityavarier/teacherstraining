...
const images = [
  { src: cert1, alt: 'Rapid Teacher Training Institute - ECCEd Certification Ceremony Ambernath' },
  { src: cert2, alt: 'Rapid TTI - ITES Certified Teacher Training Student Certification Ambernath' },
  { src: cert3, alt: 'Rapid Teacher Training Institute - ECCEd Diploma Certificate Ceremony Maharashtra' },
  { src: cert4, alt: 'Rapid TTI - Preschool Teacher Certification Ambernath East' },
  { src: cert5, alt: 'Rapid Teacher Training - ECCEd Course Completion Certification Dombivali' },
  { src: cert6, alt: 'Rapid TTI - Early Childhood Education Diploma Certification Ambernath' },
  { src: cert7, alt: 'Rapid Teacher Training Institute - ITES Certified ECCEd Student Ambernath' },
  { src: cert8, alt: 'Rapid TTI - Teacher Training Certification Award Ambernath Maharashtra' },
  { src: cert9, alt: 'Rapid Teacher Training - Preschool Teacher Diploma Certification' },
  { src: cert10, alt: 'Rapid TTI - ECCEd Certified Teacher Training Graduate Palava Dombivali' },
  { src: cert11, alt: 'Rapid Teacher Training Institute - ITES Certification Ceremony Ambernath East' },
  { src: certGroup1, alt: 'Rapid Teacher Training Institute - ECCEd Batch Certification Group Photo Ambernath' },
  { src: trio1, alt: 'Rapid TTI Trainers - Certified Jolly Phonics and Preschool Educator Team Ambernath' },
  { src: certGroup2, alt: 'ECCEd Diploma Students Group Certification - Rapid Teacher Training Palava Dombivali' },
  { src: certGroup3, alt: 'Rapid Teacher Training Institute - Preschool Teacher Training Batch Group Photo' },
  { src: group1, alt: 'Rapid TTI - Preschool Teacher Training Group Photo Ambernath Maharashtra' },
  { src: group2, alt: 'Rapid Teacher Training Institute Students Group - ECCEd Course Dombivali' },
  { src: poster1, alt: 'Rapid Teacher Training Institute - ECCEd Course Enrollment Poster Ambernath' },
  { src: poster2, alt: 'Rapid TTI - Preschool Teacher Training Course Announcement Palava Dombivali' },
  { src: poster3, alt: 'Rapid Teacher Training Institute - ITES Certified ECCEd Course Ambernath East' },
  { src: poster4, alt: 'Rapid TTI - Early Childhood Education Course Details Ambernath Maharashtra' },
  { src: poster5, alt: 'Rapid Teacher Training - ECCEd Diploma Course Advertisement Dombivali' },
  { src: poster6, alt: 'Rapid Teacher Training Institute - Teacher Training Program Poster Thane' },
  { src: teaching1, alt: 'Rapid TTI - Preschool Teaching Methodology Class Ambernath Maharashtra' }
];
